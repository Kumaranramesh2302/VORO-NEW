package com.vorowebcreator.config;

import com.vorowebcreator.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOriginPatterns(List.of("http://localhost:3000", "https://*.vorowebcreator.com"));
